...
// Package types represents the imported interface "wasi:http/types@0.2.3".
//
...
import (
	...
	ioerror "github.com/OctaHive/octabot-go-sdk/gen/wasi/io/error"
	"github.com/OctaHive/octabot-go-sdk/gen/wasi/io/poll"
	"github.com/OctaHive/octabot-go-sdk/gen/wasi/io/streams"
	"go.bytecodealliance.org/cm"
)

// Duration represents the type alias "wasi:http/types@0.2.3#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// InputStream represents the imported type alias "wasi:http/types@0.2.3#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:http/types@0.2.3#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// IOError represents the imported type alias "wasi:http/types@0.2.3#io-error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Pollable represents the imported type alias "wasi:http/types@0.2.3#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Method represents the variant "wasi:http/types@0.2.3#method".
//
...
// Scheme represents the variant "wasi:http/types@0.2.3#scheme".
//
...
// DNSErrorPayload represents the record "wasi:http/types@0.2.3#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.3#TLS-alert-received-payload".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.3#field-size-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.3#error-code".
//
...
// HeaderError represents the variant "wasi:http/types@0.2.3#header-error".
//
...
// FieldKey represents the string "wasi:http/types@0.2.3#field-key".
//
...
// FieldName represents the type alias "wasi:http/types@0.2.3#field-name".
//
// See [FieldKey] for more information.
type FieldName = FieldKey

// FieldValue represents the list "wasi:http/types@0.2.3#field-value".
//
...
// Fields represents the imported resource "wasi:http/types@0.2.3#fields".
//
...
//
//	from-list: static func(entries: list<tuple<field-name, field-value>>) -> result<fields,
//	header-error>
//
//go:nosplit
func FieldsFromList(entries cm.List[cm.Tuple[FieldName, FieldValue]]) (result cm.Result[Fields, Fields, HeaderError]) {
	entries0, entries1 := cm.LowerList(entries)
	wasmimport_FieldsFromList((*cm.Tuple[FieldName, FieldValue])(entries0), (uint32)(entries1), &result)
	return
}
...
//
//go:nosplit
func (self Fields) Append(name FieldName, value FieldValue) (result cm.Result[HeaderError, struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self Fields) Delete(name FieldName) (result cm.Result[HeaderError, struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
...
//
//go:nosplit
func (self Fields) Entries() (result cm.List[cm.Tuple[FieldName, FieldValue]]) {
	self0 := cm.Reinterpret[uint32](self)
...
//
//go:nosplit
func (self Fields) Get(name FieldName) (result cm.List[FieldValue]) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
...
//
//go:nosplit
func (self Fields) Has(name FieldName) (result bool) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
...
//
//go:nosplit
func (self Fields) Set(name FieldName, value cm.List[FieldValue]) (result cm.Result[HeaderError, struct{}, HeaderError]) {
	self0 := cm.Reinterpret[uint32](self)
	name0, name1 := cm.LowerString(name)
	value0, value1 := cm.LowerList(value)
...
// Headers represents the imported type alias "wasi:http/types@0.2.3#headers".
//
// See [Fields] for more information.
type Headers = Fields

// Trailers represents the imported type alias "wasi:http/types@0.2.3#trailers".
//
// See [Fields] for more information.
type Trailers = Fields

// IncomingRequest represents the imported resource "wasi:http/types@0.2.3#incoming-request".
//
...
// OutgoingRequest represents the imported resource "wasi:http/types@0.2.3#outgoing-request".
//
...
// RequestOptions represents the imported resource "wasi:http/types@0.2.3#request-options".
//
...
// ResponseOutparam represents the imported resource "wasi:http/types@0.2.3#response-outparam".
//
...
// StatusCode represents the u16 "wasi:http/types@0.2.3#status-code".
//
...
// IncomingResponse represents the imported resource "wasi:http/types@0.2.3#incoming-response".
//
...
// IncomingBody represents the imported resource "wasi:http/types@0.2.3#incoming-body".
//
...
// FutureTrailers represents the imported resource "wasi:http/types@0.2.3#future-trailers".
//
...
// OutgoingResponse represents the imported resource "wasi:http/types@0.2.3#outgoing-response".
//
...
// OutgoingBody represents the imported resource "wasi:http/types@0.2.3#outgoing-body".
//
...
// FutureIncomingResponse represents the imported resource "wasi:http/types@0.2.3#future-incoming-response".
//
