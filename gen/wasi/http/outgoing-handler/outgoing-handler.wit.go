...
// Package outgoinghandler represents the imported interface "wasi:http/outgoing-handler@0.2.3".
//
...
// OutgoingRequest represents the imported type alias "wasi:http/outgoing-handler@0.2.3#outgoing-request".
//
// See [types.OutgoingRequest] for more information.
type OutgoingRequest = types.OutgoingRequest

// RequestOptions represents the imported type alias "wasi:http/outgoing-handler@0.2.3#request-options".
//
// See [types.RequestOptions] for more information.
type RequestOptions = types.RequestOptions

// FutureIncomingResponse represents the imported type alias "wasi:http/outgoing-handler@0.2.3#future-incoming-response".
//
// See [types.FutureIncomingResponse] for more information.
type FutureIncomingResponse = types.FutureIncomingResponse

// ErrorCode represents the type alias "wasi:http/outgoing-handler@0.2.3#error-code".
//
