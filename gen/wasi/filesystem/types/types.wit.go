...
// Package types represents the imported interface "wasi:filesystem/types@0.2.3".
//
...
import (
	wallclock "github.com/OctaHive/octabot-go-sdk/gen/wasi/clocks/wall-clock"
	"github.com/OctaHive/octabot-go-sdk/gen/wasi/io/streams"
	"go.bytecodealliance.org/cm"
)

// InputStream represents the imported type alias "wasi:filesystem/types@0.2.3#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:filesystem/types@0.2.3#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Error represents the imported type alias "wasi:filesystem/types@0.2.3#error".
//
// See [streams.Error] for more information.
type Error = streams.Error

// DateTime represents the type alias "wasi:filesystem/types@0.2.3#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// FileSize represents the u64 "wasi:filesystem/types@0.2.3#filesize".
//
...
// DescriptorType represents the enum "wasi:filesystem/types@0.2.3#descriptor-type".
//
...
// DescriptorFlags represents the flags "wasi:filesystem/types@0.2.3#descriptor-flags".
//
// Descriptor flags.
//
...
// PathFlags represents the flags "wasi:filesystem/types@0.2.3#path-flags".
//
...
// OpenFlags represents the flags "wasi:filesystem/types@0.2.3#open-flags".
//
...
// LinkCount represents the u64 "wasi:filesystem/types@0.2.3#link-count".
//
...
// DescriptorStat represents the record "wasi:filesystem/types@0.2.3#descriptor-stat".
//
// File attributes.
//
...
// NewTimestamp represents the variant "wasi:filesystem/types@0.2.3#new-timestamp".
//
...
// DirectoryEntry represents the record "wasi:filesystem/types@0.2.3#directory-entry".
//
// A directory entry.
//
...
// ErrorCode represents the enum "wasi:filesystem/types@0.2.3#error-code".
//
...
// Advice represents the enum "wasi:filesystem/types@0.2.3#advice".
//
...
// MetadataHashValue represents the record "wasi:filesystem/types@0.2.3#metadata-hash-value".
//
...
// Descriptor represents the imported resource "wasi:filesystem/types@0.2.3#descriptor".
//
...
// DirectoryEntryStream represents the imported resource "wasi:filesystem/types@0.2.3#directory-entry-stream".
//
